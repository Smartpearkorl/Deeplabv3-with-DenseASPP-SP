...
if __name__ == "__main__":
    ...
    if local_rank == 0:
        show_config(
            ...
            Finetune_Train= Finetune_Train,Init_lr = Init_lr, Min_lr = Min_lr, optimizer_type = optimizer_type, momentum = momentum, lr_decay_type = lr_decay_type, \
    ...
    if True:
        ...
        # if Finetune_Train:
        #     Init_lr_fit = 1e-1 * Init_lr_fit
        #     Min_lr_fit = 1e-1 * Min_lr_fit
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            set_optimizer_lr(optimizer, lr_scheduler_func, epoch ,Finetune_Train)
