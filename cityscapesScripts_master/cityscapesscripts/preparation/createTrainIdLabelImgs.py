...
os.environ['CITYSCAPES_DATASET'] = "D:/Python_Deeplabv3p/VOCdevkit/Cityscapes"
# The main method
def main():
    ...
    # filepath = glob.glob('D:/Python_Deeplabv3p/VOCdevkit/Cityscapes/gtFine/test/berlin/*_gt*_polygons.json')
    # filepath.sort()
