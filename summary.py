...
# device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
# model = DeepLab(num_classes=num_classes, backbone=backbone, downsample_factor=16, pretrained=False).to(device)
# summary=torchinfo.summary(model, (3, input_shape[0], input_shape[1]), batch_dim=0,
...
# print(torchinfo.summary(model, (3, 224, 224), batch_dim = 0, col_names = ('input_size', 'output_size', 'num_params', 'kernel_size',
#                                                                     'mult_adds'), verbose = 0))
